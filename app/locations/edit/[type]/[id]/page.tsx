  ...
  useEffect(() => {
    const loadLocation = async () => {
      ...
      setForm({
        ...
        roseout_score: data.roseout_score ?? data.quality_score ?? "",
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mb-6 rounded-[2rem] border border-white/10 bg-[#111] p-6 shadow-2xl">
          ...
          <p className="mt-2 text-sm text-neutral-400">
            Add details that make your location stand out and help RoseOut match
            you to better searches.
          </p>
        </section>
          ...
          <section className="space-y-6">
            ...
            <Panel title="Experience Matching Details">
              ...
              <Field
                ...
                placeholder="Date night, birthday, girls night, brunch, first date"
              />
              ...
              <Field
                ...
                placeholder="Lobster pasta, mocktails, private rooms"
              />
            </Panel>
            ...
            <Panel title="Search Tags & Ranking">
              ...
              <Field
                ...
                placeholder="brunch, date night, anniversary, Queens, cocktails"
              />

        ...
        <div className="relative z-10 mx-auto flex min-h-[70vh] max-w-6xl flex-col justify-between px-5 py-8">
          ...
          <div className="max-w-3xl pb-8">
            <div className="mb-4 flex flex-wrap gap-2">
              ...
              <span className="rounded-full bg-white/20 px-4 py-1.5 text-xs font-bold uppercase tracking-wide text-white backdrop-blur">
            ...
            <p className="mt-4 text-lg text-neutral-200">{category}</p>
        ...
        <div className="space-y-6">
          <div className="rounded-[2rem] bg-white p-6 text-black shadow-2xl">
            ...
            <p className="mt-4 leading-7 text-neutral-700">
              {item.description ||
                `${name} was selected based on atmosphere, location, rating, and date-night fit.`}
            </p>

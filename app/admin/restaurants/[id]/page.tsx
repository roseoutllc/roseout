      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[1fr_360px]">
        <div className="space-y-6">
          ...
          <section className="rounded-3xl bg-white p-6 text-black">
            ...
            <div className="mt-5 grid gap-4">
              <input className="rounded-xl border px-4 py-3" value={form.restaurant_name || ""} onChange={(e) => update("restaurant_name", e.target.value)} placeholder="Restaurant Name" />
              <input className="rounded-xl border px-4 py-3" value={form.address || ""} onChange={(e) => update("address", e.target.value)} placeholder="Address" />

              <div className="grid gap-4 md:grid-cols-3">
                <input className="rounded-xl border px-4 py-3" value={form.city || ""} onChange={(e) => update("city", e.target.value)} placeholder="City" />
                <input className="rounded-xl border px-4 py-3" value={form.state || ""} onChange={(e) => update("state", e.target.value)} placeholder="State" />
                <input className="rounded-xl border px-4 py-3" value={form.zip_code || ""} onChange={(e) => update("zip_code", e.target.value)} placeholder="Zip Code" />
              </div>

              <input className="rounded-xl border px-4 py-3" value={form.phone || ""} onChange={(e) => update("phone", e.target.value)} placeholder="Phone" />
              <textarea className="min-h-32 rounded-xl border px-4 py-3" value={form.description || ""} onChange={(e) => update("description", e.target.value)} placeholder="Description" />
            </div>
          </section>
          ...
          <section className="rounded-3xl bg-white p-6 text-black">
            ...
            {form.image_url && (
              <img src={form.image_url} alt={form.restaurant_name || "Restaurant"} className="mt-5 max-h-72 w-full rounded-2xl object-cover" />
            )}
          </section>
        </div>
        ...
        <aside className="space-y-6">
          ...
          <section className="rounded-3xl bg-white p-6 text-black">
            ...
            <div className="mt-4 grid gap-3">
              <input className="rounded-xl border px-4 py-3" value={form.rating || ""} onChange={(e) => update("rating", e.target.value)} placeholder="Rating" />
              <input className="rounded-xl border px-4 py-3" value={form.review_count || ""} onChange={(e) => update("review_count", e.target.value)} placeholder="Review Count" />
              <input className="rounded-xl border px-4 py-3" value={form.quality_score || ""} onChange={(e) => update("quality_score", e.target.value)} placeholder="Quality Score" />
              <input className="rounded-xl border px-4 py-3" value={form.popularity_score || ""} onChange={(e) => update("popularity_score", e.target.value)} placeholder="Popularity Score" />
            </div>
          </section>

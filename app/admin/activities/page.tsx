    ...
    <div>
      <div className="mb-8">
        ...
        <p className="mt-3 text-neutral-400">
          Manage activity inventory with search, filters, claim status, stats,
          and fast editing.
        </p>
      </div>
      ...
      <section className="mb-6 rounded-[2rem] bg-white p-5 text-black shadow-xl">
        <form className="grid gap-4 md:grid-cols-[1fr_220px_140px]">
          <input
            name="q"
            defaultValue={q}
            placeholder="Search by activity, city, or type..."
      ...
      <section className="overflow-hidden rounded-[2rem] bg-white text-black shadow-2xl">
        <div className="flex flex-col gap-3 border-b border-neutral-200 p-5 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="text-xl font-bold">Activity Listings</h2>
              ...
              <tbody>
                {activities.map((activity) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-4">{activity.city || "N/A"}</td>
                    ...
                    <td className="px-5 py-4">⭐ {activity.rating || 0}</td>

                    <td className="px-5 py-4">{activity.view_count || 0}</td>

                    <td className="px-5 py-4">{activity.click_count || 0}</td>

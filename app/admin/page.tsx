    ...
    <main className="mx-auto max-w-7xl px-6 py-10 text-white">
      ...
      <section className="mt-8 overflow-hidden rounded-3xl bg-white text-black">
        <div className="grid grid-cols-12 bg-neutral-100 px-5 py-4 text-xs font-black uppercase tracking-wide text-neutral-500">
          ...
          <div className="col-span-2">RoseOut Rating</div>
          ...
          return (
            ...
            >
              ...
              <div className="col-span-3">
                <Link href={location.edit_path} className="font-black hover:underline">
              ...
              <div className="col-span-2">
                <StarRating score={location.roseout_score || 0} />
              </div>
  ...
  return (
    <div>
      <div className="flex text-xl text-yellow-500">
        {[1, 2, 3, 4, 5].map((star) => (
          <span key={star}>{starScore >= star ? "★" : "☆"}</span>
        ))}
      </div>

  ...
  return (
    <main className="min-h-screen bg-black px-6 py-12 text-white">
      <div className="mx-auto max-w-2xl">
        <h1 className="text-4xl font-bold">What kind of night are you planning?</h1>
        ...
        <div className="mt-8 rounded-3xl bg-white p-6 text-black">
          <textarea
            ...
            placeholder="Example: Plan a romantic date night in Queens for Saturday evening under $150 with dinner, dessert, and something fun after."
            value={request}

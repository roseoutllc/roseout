...
import { createSupportTicket, getAdminNotifyEmail, getAdminNotifyPhone, renderSupportEmail, supportEmailFrom } from "@/lib/support";
...
async function sendContactFallback({
  ...
  await sendNotification({
    ...
    smsBody: `RoseOut contact fallback from ${name} <${email}> (${topic || "General"}): ${message}`,
  });
}

...
const rateRules: Array<{ prefix: string; limit: number; windowMs: number }> = [
  ...
  { prefix: "/api/business/website", limit: 20, windowMs: 60_000 },
  { prefix: "/api/careers", limit: 15, windowMs: 60_000 },
  { prefix: "/api/beta", limit: 60, windowMs: 60_000 },
  { prefix: "/api/launch/waitlist", limit: 10, windowMs: 60_000 },
  { prefix: "/api/public/large-group-bookings", limit: 12, windowMs: 60_000 },
  { prefix: "/api/experiences", limit: 30, windowMs: 60_000 },
  { prefix: "/api/events", limit: 45, windowMs: 60_000 },
  { prefix: "/api/support", limit: 20, windowMs: 60_000 },
  { prefix: "/api/user/support", limit: 30, windowMs: 60_000 },
  { prefix: "/api/explore", limit: 60, windowMs: 60_000 },
  { prefix: "/api/search", limit: 90, windowMs: 60_000 },
  { prefix: "/api/generate", limit: 30, windowMs: 60_000 },
  { prefix: "/api/google/import", limit: 10, windowMs: 60_000 },
  { prefix: "/api/locations/optimize", limit: 20, windowMs: 60_000 },
  { prefix: "/api/locations/apply", limit: 15, windowMs: 60_000 },
  { prefix: "/api/restaurants/apply", limit: 15, windowMs: 60_000 },
  { prefix: "/api/activity/track", limit: 120, windowMs: 60_000 },
  { prefix: "/api/restaurants/track", limit: 120, windowMs: 60_000 },
  { prefix: "/api/image-proxy", limit: 60, windowMs: 60_000 },
